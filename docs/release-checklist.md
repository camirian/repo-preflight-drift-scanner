...
Use this release checklist before creating a user ZIP or publishing a new tag.
...
Run `make package` and confirm it creates `release/ai-agent-repo-preflight-kit-v0.5.zip`.

Inspect the ZIP and confirm it excludes `.git`, caches, generated reports, and private planning notes.

## release package

Confirm user quickstart exists.
...
A user should be able to understand, run, and package the tool without contacting the seller.
