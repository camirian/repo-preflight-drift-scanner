...
If you consume `REPO_PREFLIGHT_REPORT.json` in automation, validate it against the version-pinned schema artifact described in [JSON report schema](../report-schema.md).
