...
- `docs/user/`: user-facing setup and usage documentation included in the v0.4 package.
- `scripts/package_release.sh`: creates the v0.4 QA artifact boundary.
...
- release package must be verified as an extracted artifact, not only as a source tree.
